...
class C1 : virtual public B {	//virtual
public:
	C1(int a = 0xC1A, int b = 0xC1B) 
		: B(a, b) {} 
};

class C2 : virtual public B {	//virtual
public:
...
public:
	D1(int C1_a = 0xD1C1A, int C2_a = 0xD1C2A, 
	   int C1_b = 0xD1C1B, int C2_b = 0xD1C2B) 
		: C1(C1_a, C1_b), C2(C2_a, C2_b), A(0xD1A) {} //A in D1 initialisiert                                                     
	void print() {
		cout << "D1::print() ..." << endl;
		string strArr[] = 
			{ "C1::a", "C2::a", "C1::b", "C2::b" };
...
public:
	D2(int C1_a = 0xD2C1A, int C2_a = 0xD2C2A, int C3_a = 0xD2C3A, 
	   int C1_b = 0xD2C1B, int C2_b = 0xD2C2B, int C3_b = 0xD2C3B) 
		: C1::B(C3_a, 0xD2B), C2(C2_a, C2_b), C3(C3_a, C3_b) {}	//A über C1 initialisiert
	void print() { 
		cout << "D2::print() ..." << endl;
